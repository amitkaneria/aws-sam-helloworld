...
if option == 1:
    ...
    print(str(ticker_list_db))
    for ticker in ticker_list_db:
        print(ticker)
        process_ema50_data_for(ticker, api_key=API_KEY, interval=interval, date=None)
        process_ema200_data_for(ticker, api_key=API_KEY, interval=interval, date=None)
